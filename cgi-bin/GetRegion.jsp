...
try {
	...
	String myQuery = "SELECT gid, first_name as name, ST_AsText(ST_Envelope(geom)) as extent,ST_AsText(ST_PointOnSurface(geom)) as centroid FROM geodata.level2 WHERE gid = " + gid;
