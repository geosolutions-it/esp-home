...
try {
	...
	String myQuery = "SELECT gid, name2 as name, name3, ST_AsText(ST_Envelope(geom)) as extent,ST_AsText(ST_PointOnSurface(geom)) as centroid FROM geodata.level3 WHERE gid = " + gid;
	...
	String myjson="{\"GetSubRegionResult\":";
