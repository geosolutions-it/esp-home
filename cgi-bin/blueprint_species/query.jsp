...
//			}
		...
		if(includemetadata){
			...
			for (int i=1; i<=count; i++) {
					...
					myjson +="\"type\":\""+md.getColumnTypeName(i)+"\"";
					myjson=myjson+"}";
			}
			myjson+="],";
			myjson+="\"records\":"+rowcnt+",";
			myjson+="\"duration\":"+(new java.util.Date().getTime()-startdate.getTime())+",";
			myjson+="\"idProperty\":\""+md.getColumnName(1)+"\",";
			myjson+="\"root\":\"records\"";
