...
try {
	...
	String level2gid = request.getParameter("lev2gid");
	String driver = "org.postgresql.Driver";
	String url = "jdbc:postgresql://durga.jrc.org:5432/dbgeo";
	String username = "usrgeo";
	String password = "U5493o";
	String myDataField = null;
	String myQuery = "SELECT gid, name2 as name FROM geodata.level3 WHERE lev2gid = " + level2gid+" ORDER BY NAME";
	...
	String myjson="{\"ListSubRegionsResult\":[";
