...
try {
	...
	if(decadestart==null)decadestart="20100101";
	String decadeend= request.getParameter("decadeend");
	if(decadeend==null)decadeend="29999999";

	String urlpa = "jdbc:postgresql://species.jrc.org:5432/dopa";
	String unamepa = "appuser";
	String pwordpa = "5Ti5k9";
	String geomfield = null;
//"SELECT name, ST_AsText(geom) as geom FROM administrative_units.adminunit_gaul2008 where country_id = " + id +" AND admin_level = 0;";
	...
	myQryPa += " FROM administrative_units.adminunit_gaul2008 ";
	myQryPa += " where country_id = " + id +" AND admin_level = 0;";
